...
export default function home() {
  return (
    ...
    >
      <div className="md:flex-row flex flex-col max-w-screen-lg mx-auto w-4/5 justify-center items-center h-screen bg-bg1">
        <div className="flex flex-col justify-center items-center w-full text-center md:text-left md:items-start pr-3">
          ...
          <div>
            <Link
              ...
              spy={true}
              smooth={true}
              className="group flex justify-center cursor-pointer items-center bg-blue-50 text-cyan-800 border-color: rgb(212 212 212); p-2 rounded-md text-2xl my-10 font-bold"
            >
              Portfolio
        ...
        <div className="w-full ml-0 md:ml-10">
          <img
            src={myImg}
            alt="my pic"
            className="rounded-2xl mx-auto w-3/4 md:w-4/5 mt-6 "
          />
        </div>
      </div>
    </div>
